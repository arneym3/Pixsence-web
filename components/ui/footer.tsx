        ...
        >
          ...
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link className="text-gray-500 transition hover:text-blue-500" href="#0">GroundGuard</Link>
              </li>
              <li>
                <Link className="text-gray-500 transition hover:text-blue-500" href="#0">PowerQuality</Link>
              </li>
              <li>
                <Link className="text-gray-500 transition hover:text-blue-500" href="#0">AirSense</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-4">
            ...
            <ul className="flex gap-4">
              ...
              <li>
                <Link
                  className="flex items-center justify-center text-gray-400 transition hover:text-blue-500"
                  href="https://github.com/arneym3/Pixsence-Global"
                  aria-label="Github"
                >
                  <svg className="h-6 w-6 fill-current" viewBox="0 0 32 32">
